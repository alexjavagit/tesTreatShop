                ...
                <div class="row">
                    <div class="col-md-5">
                        ...
                        <div class="form-group form-group-icon-left"><i class="fa fa-user input-icon"></i>
                            ...
                            <input class="form-control" name="firstName" value="${theUser.firstName}" type="text"
                                   required/>
                        </div>
                        <div class="form-group form-group-icon-left"><i class="fa fa-user input-icon"></i>
                            <label>Last Name</label>
                            <input class="form-control" name="lastName" value="${theUser.lastName}" type="text"
                                   required/>
                        </div>
                        <div class="form-group form-group-icon-left"><i class="fa fa-envelope input-icon"></i>
                            <label>E-mail</label>
                            <input class="form-control" name="email" value="${theUser.email}" type="email" required
                                   pattern="[^@]+@[^@]+\.[a-zA-Z]{2,6}"/>
                        </div>
                        <div class="form-group form-group-icon-left"><i class="fa fa-phone input-icon"></i>
                            <label>Phone Number</label>
                            <input class="form-control" id="phone" name="phone" value="${theUser.phone}" type="phone"
                        ...
                        <div class="form-group">
                            <label>Login</label>
                            <input class="form-control" name="login" value="${theUser.login}" type="text" required
