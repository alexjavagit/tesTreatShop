        ...
        <div class="row">
            <div class="col-md-3">
                <div class="form-group form-group-icon-left"><i
                    ...
                    <label>E-Mail</label>
                    <input class="typeahead form-control" name="searchEmail" value="${param.searchEmail}" placeholder=""
                           type="text"/>
                </div>
            </div>
            <div class="col-md-3">
                <div class="form-group form-group-icon-left"><i
                        class="fa fa-map-marker input-icon input-icon-hightlight"></i>
                    <label>Login</label>
                    <input class="typeahead form-control" name="searchLogin" value="${param.searchLogin}" placeholder=""
                           type="text"/>
                </div>
            </div>
            <div class="col-md-2">
                                        ...
                                        <div class="col-md-4">
                                            <div class="booking-item-airline-logo">
                                                <p class="booking-item-date"
                                                   style="font-size: 14px;!important">${user.firstName} ${user.lastName}</p>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="booking-item-flight-details">
                                                <div class="booking-item-arrival">
                                                    <p class="booking-item-date"
                                                       style="font-size: 14px;!important">${user.email}</p>
                                                </div>
                                                <div class="booking-item-departure">
                                                    <p class="booking-item-date"
                                                       style="font-size: 14px;!important">${user.login}</p>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-2">
