        ...
        return new CommandLineRunner() {
            ...
            public void run(String... strings) throws Exception {
                ...
                for (int i = 1; i <= 10; i++) {
                    ...
                    productImages = new ProductImages(product, "1.jpeg");
                    productImagesService.saveImage("./pics/men/1.jpeg", productImages);
                    listProductImages.add(productImages);
                    productImages = new ProductImages(product, "1.jpeg");
                    productImagesService.saveImage("./pics/men/2.jpeg", productImages);
                    listProductImages.add(productImages);
                ...
                for (int i = 1; i <= 10; i++) {
                    ...
                    List<ProductImages> listProductImages = new ArrayList<>();
                    productImages = new ProductImages(product, "1.jpeg");
                    productImagesService.saveImage("./pics/women/1.jpeg", productImages);
                    listProductImages.add(productImages);
                    productImages = new ProductImages(product, "1.jpeg");
                    productImagesService.saveImage("./pics/men/1.jpeg", productImages);
                    listProductImages.add(productImages);
                ...
                for (int i = 1; i <= 10; i++) {
                    ...
                    List<ProductImages> listProductImages = new ArrayList<>();
                    productImages = new ProductImages(product, "1.jpeg");
                    productImagesService.saveImage("./pics/children/1.jpeg", productImages);
                    listProductImages.add(productImages);
                    productImages = new ProductImages(product, "1.jpeg");
                    productImagesService.saveImage("./pics/children/1.jpeg", productImages);
                    listProductImages.add(productImages);
