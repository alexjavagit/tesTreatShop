        ...
        <div class="row">
            <div class="col-md-3">
                <div class="form-group form-group-icon-left"><i class="fa fa-map-marker input-icon input-icon-hightlight"></i>
                    ...
                    <input class="typeahead form-control" value="${searchId}" placeholder="" name="searchId" type="text" />
                </div>
            </div>
            <div class="col-md-3">
                <div class="form-group form-group-icon-left"><i class="fa fa-map-marker input-icon input-icon-hightlight"></i>
                    <label>Customer Name</label>
                    <input class="typeahead form-control" value="${searchName}" placeholder="" name="searchName" type="text" />
                </div>
            </div>
            <div class="col-md-2">
        ...
        <div class="col-md-12">
            <div class="nav-drop booking-sort">
                ...
                <ul class="nav-drop-menu">
                    <li onClick="window.location='/admin/orders?searchId=${searchId}&searchName=${searchName}&searchEmail=${searchEmail}&sortBy=id&order=asc';"><a href="">Id (low to high)</a>
                    </li>
                    <li onClick="window.location='/admin/orders?searchId=${searchId}&searchName=${searchName}&searchEmail=${searchEmail}&sortBy=name&order=asc';"><a href="">Name (low to high)</a>
                    </li>
                    <li onClick="window.location='/admin/orders?searchId=${searchId}&searchName=${searchName}&searchEmail=${searchEmail}&sortBy=name&order=desc';"><a href="#">Name (high to low)</a>
                    </li>
                    <li onClick="window.location='/admin/orders?searchId=${searchId}&searchName=${searchName}&searchEmail=${searchEmail}&sortBy=total&order=asc';"><a href="#">Total (low to high)</a>
                    <li onClick="window.location='/admin/orders?searchId=${searchId}&searchName=${searchName}&searchEmail=${searchEmail}&sortBy=total&order=desc';"><a href="#">Total (high to low)</a>
                    </li>
                </ul>
            </div>
                        ...
                        <div class="booking-item">
                            <div class="row">
                                ...
                                <div class="col-md-2">
                                    ...
                                    <a class="btn btn-primary" href="#" onClick="javascript: if (confirm('Are you sure you want to delete this order?')) delete_order(${order.id});">Delete</a>
                                </div>
                            </div>
                        </div>
                    </div>
