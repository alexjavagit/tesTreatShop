    ...
    <c:if test="${not empty param.search_for}">
        <form method="get">
            <div class="row">
                <div class="col-md-4">
                    <div class="">
                        <input class="typeahead form-control" name="search_for" type="text"
                               value="${param.search_for}"/>
            ...
            <div class="col-md-3">
                <div class="thumb">
                    ...
                    <div class="thumb-caption">
                        <h5 class="thumb-title"><a class="text-darken" href="/product/${product.id}">${product.name}</a>
                        </h5>
