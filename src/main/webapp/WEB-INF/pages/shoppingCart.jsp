        ...
        <div class="col-md-9">
            ...
            <ul class="booking-list">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <p class="booking-item-address" style="font-size: 16px;!important;">Qty:
                                    <a href="#"
                                       onClick="javascript: removeProductQtyFromCart(${product.getValue().id},'${productsSizes.get(product.getKey())}',${dPrice.intValue()});"
                                       class="fa fa-minus-circle" style="font-size: 18px;!important;"></a> <span
                                            id="qty_${product.getKey()}">${productsQty.get(product.getKey())}</span> <a
                                            href="#"
                                            onClick="javascript: addProductQtyToCart(${product.getValue().id},'${productsSizes.get(product.getKey())}',${dPrice.intValue()})"
                                            class="fa fa-plus-circle" style="font-size: 18px;!important;"></a>
                                </p>
                            </div>
                ...
                <li id="checkoutli" <c:if test="${products.size() eq 0}">style="display: none"</c:if>>
                    <div class="row">
                        <div class="col-md-9"></div>
                        <div class="booking-item-title"><a href="/shoppingCart/checkout" class="btn btn-primary btn-lg">Checkout
                            >></a></div>
                    </div>
                </li>
            </ul>
